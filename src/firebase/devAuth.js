...
const TEST_ACCOUNTS = [
  ...
  {
    uid: 'dev-user-qa',
    email: import.meta.env.VITE_DEV_EMAIL_QA || 'qa@mindforge.dev',
    password: import.meta.env.VITE_DEV_PASSWORD_QA || 'qa!Secure2025',
    profile: {
      uid: 'dev-user-qa',
      username: 'QA_Admin',
      email: import.meta.env.VITE_DEV_EMAIL_QA || 'qa@mindforge.dev',
      createdAt: new Date('2024-06-01'),
      avatar: { skinColor: '#c68642', hairColor: '#2c1b18', hairStyle: 'short', eyes: 'normal' },
      bio: 'Quality Assurance - Full Access',
      isPremium: true,
      isAdmin: true,
      premiumTier: 'dev',
      isTeacher: true,
